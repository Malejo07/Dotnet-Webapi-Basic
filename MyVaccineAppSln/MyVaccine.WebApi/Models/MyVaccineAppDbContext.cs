    ...
    public class MyVaccineAppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Dependent>(entity =>
            {
                ...
                entity.HasOne(d => d.User)// Un usuario puede tener multiples dependientes.
                    .WithMany(u => u.Dependents)// Un dependiente puede estar con un usuario.
                    .HasForeignKey(d => d.UserId)//Un dependiente no puede crearse sin haber creado antes el usuario al que pertenece.
                    .OnDelete(DeleteBehavior.Cascade);// Se eliminan en cascada, es decir, si eliminas un usuario se elimina sus dependientes.
            });
